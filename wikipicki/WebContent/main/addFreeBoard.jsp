...
<title>board</title>
	...
	<article>
		<div class="container" role="main"  >
			<h2>글 등록</h2>
			<form name="form" id="form" role="form" enctype="multipart/form-data" method="post" action="${pageContext.request.contextPath}/main/addFreeBoard">
				<div class="mb-3">
			...
			<div >
				<button type="button" class="btn btn-sm btn-primary" id="addBoard">등록</button>
				<button type="button" class="btn btn-sm btn-primary" id="freeBoardList">목록</button>
			</div>
		</div>
	</article>
</body>
